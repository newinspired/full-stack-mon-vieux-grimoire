...
exports.signup = (req, res, next) => {
    ...
    bcrypt.hash(req.body.password, 10)  // Appel de la fonction de hachage de bcrypt dans le MDP (qui est "salé" 10 fois)
      .then(hash => { // Utilisation du hash pour créer un utilisateur
